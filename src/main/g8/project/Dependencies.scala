...
object Dependencies {
  ...
  object Libraries {
    ...
    val apacheCommonsLang     = "org.apache.commons"      % "commons-lang3" % V.apacheCommonsLang
    val apacheCommonsText     = "org.apache.commons"      % "commons-text"  % V.apacheCommonsText
    val apacheCommonsIo       = "commons-io"              % "commons-io"    % V.apacheCommonsIo
    ...
    val http4sCirce     = http4s("circe") // circe to EntityEncoder

    val http4sScalaTags = "org.http4s" %% "http4s-scalatags" % V.http4sScalaTags
    ...
    // scala test
    val scalatic          = "org.scalactic"       %% "scalactic" % V.scalaTest % "test"
